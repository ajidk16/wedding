  ...
  >
    ...
    <div className="absolute inset-0">
      <img
        ...
        className="w-full h-full object-cover opacity-15 md:opacity-25"
      />
    </div>
        ...
        <div className="backdrop-blur-sm bg-white/50 p-6 sm:p-8 md:p-10 rounded-2xl border border-rose-100/50 shadow-xl">
          ...
          >
            <img
              ...
              alt="Foto Pengantin"
              className="w-40 h-40 sm:w-48 sm:h-48 object-cover rounded-full border-4 border-white shadow-md"
            />
          </motion.div>
          ...
          >
            <div className="space-y-2">
              <h1 className="text-xl sm:text-4xl md:text-3xl font-serif text-gray-800 leading-tight">
                {config.data.groomName} <br />{" "}
